...
def task():
    ...
    natural_language_understanding=NaturalLanguageUnderstandingV1(version='2018-11-16',iam_apikey=<ibm api key> ,url='https://gateway-lon.watsonplatform.net/natural-language-understanding/api')
...
if __name__ == "__main__":
    ...
    def task3():
        ...
        if sed_txt=='':
            ...
            df_response_fp=detect_intent_texts(<google api json project name>,'unique',sed_txt,'en')
    ...
    def resp():
        while(1):
            ...
            if user_input in list_of_extended_ques:
                ...
                df_response=detect_intent_texts(<google api json project name>,'unique',user_input,'en')
