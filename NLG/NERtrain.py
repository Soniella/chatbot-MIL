...
#         print("input_tensor: ", input_tensor)
        ...
        print("steps: ", steps)
        #if steps%5000 == 0:
        torch.save(encoder, "C:/<path>/encode.pth") #"drive\\app\\NERnlgenc.pth")
        torch.save(decoder, "C:/<path>/decode.pth")
        print("Done")

            #torch.save(encoder, ".\\static\\NERnlgenc") #"drive\\app\\NERnlgenc.pth")
            #torch.save(decoder, ".\\static\\NERnlgdec") #"drive\\app\\NERnlgdec.pth")
