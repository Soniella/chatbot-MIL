...
#L = [" Vaults expensive Chinese riverside 2 5 rating not friendly", "The Eagle cheap Italian not friendly"]
L=["she fine","she coming"]

trainset = pd.read_csv('.\\data\\processedTrainset.csv')
...
encoder = torch.load("C:/<path>/encode.pth")#map_location = 'cpu')
decoder = torch.load("C:/<path>/decode.pth")#map_location = 'cpu')
